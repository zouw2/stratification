...
rice_session(
  {
   ...
   # 
    raw <- rice_read_zip('root/clinical_studies/RO7496353/CDT70424/GO44010/source/other/prod/GO44010_Daily_Extract_20240321071609.zip')
   # 
rs <- as.data.frame( rice_read("root/clinical_studies/RO7496353/CDT70424/GO44010/data_analysis/IMC_3rd/data/sdtmv/rs.sas7bdat"))

tu <- as.data.frame( rice_read("root/clinical_studies/RO7496353/CDT70424/GO44010/data_analysis/IMC_3rd/data/sdtmv/tu.sas7bdat"))

tr <- as.data.frame( rice_read("root/clinical_studies/RO7496353/CDT70424/GO44010/data_analysis/IMC_3rd/data/sdtmv/tr.sas7bdat"))
