# para <- c('27519', '60,60',  '20', '0.8,0.8', '27.7,17.2', '50', 'oneFactor')
 #para <- c('27519', '56,92,10,18,166,276,32,52','20','0.8,0.8,0.8,0.8,0.8,0.8,0.8,0.8' ,'23.2,19,16.2,13.3,16.2,13.3,11.4,9.3' ,'53.5' ,'imp150_sim1')
...
set.seed(seed.base)
r1 <- sim3(p=pL, time = readoutTime, estimatePrognostic = F, maxPms = 20, rampUpTime = 20 ) 
